...
class DecisionPOSet(POSet):
    ...
    def differentiate(self):
        ...
        for drule_i, drule in enumerate(diff_poset.decision_rules):
            ...
            diff_poset._targets[drule_i] -= sum([old_targets[dsup_i] for dsup_i in dsup_rules_i])
        return diff_poset
    ...
    def integrate(self):
        ...
        for drule_i, drule in enumerate(int_poset.decision_rules):
            ...
            diff_poset._targets[drule_i] += sum([old_targets[sup_i] for sup_i in sup_rules_i])
        return int_poset
...
class DecisionSemiLattice(DecisionPOSet):
    pass


class DecisionTree(DecisionSemiLattice, BinaryTree):
    pass
